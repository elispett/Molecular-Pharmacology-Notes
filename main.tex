...
\begin{figure}%
    \centering
    \subfloat[\centering Nicotinic receptors are permeable to positive ions: Na+, K+ e Ca2+]{{\includegraphics[width=0.3\textwidth]{images3/image4_1.png} }}%
    \qquad
    \subfloat[\centering Nicotinic receptors are found in the CNS and at the neuromuscular junction.]{{\includegraphics[width=0.6\textwidth]{images3/image4.png} }}%
